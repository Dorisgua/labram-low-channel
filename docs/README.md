...
## 4. 当前标准 wrapper 的训练与 checkpoint 配置
...
### 5.1 各数据集核心目标达成情况（当前新实验；A/N/O seed = 0）
...
| ERP-Core | △<br>Acc O/A/N：57.60% / 61.38% / 60.59%<br>BAcc O/A/N：44.36% > 40.29% > 39.73% | ✅<br>Acc A/N：61.38% > 60.59%<br>BAcc A/N：40.29% > 39.73% | ❌<br>Acc A/N：61.38% < 64.42%<br>BAcc A/N：40.29% < 45.42% | Test Acc：64.61%<br>Test BAcc：48.91% | ❌<br>Acc D/A：60.46% < 61.38%<br>BAcc D/A：38.46% < 40.29% | CSLP<br>Test Acc：48.48±0.34%  |
