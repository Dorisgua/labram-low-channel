...
DATA_PATH="${DATA_PATH:-/inspire/hdd/project/sais-medical/public/share_medical/EEG/HGD/processed_data_4s_200hz}"
...
EXP_GROUP="${EXP_GROUP:-preexp39_hgd78_adabrain_real_official_split}"
