#!/usr/bin/env bash
set -euo pipefail
# PhysioNet: use 23 real channels, complete to 64 with train-set CNN
...
export COMPLETION_SCOPE="physionet23_with_physionet64"
...
export EXP_GROUP="preexp34_physionet23_with_physionet64_prototype_motor_imagery"
