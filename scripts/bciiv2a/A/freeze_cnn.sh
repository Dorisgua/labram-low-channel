...
export OUTPUT_SCRIPT_NAME="${OUTPUT_SCRIPT_NAME:-bciiv2a_A_freeze_cnn}"
export CHANNEL_SUBSET="bciiv2a13" COMPLETION_SCOPE="bciiv2a13_with_bciiv2a22" POOLING_SCOPE="high" FREEZE_CNN="1"
export CHANNEL_PROTOTYPE_PATH="${CHANNEL_PROTOTYPE_PATH:-docs/prototypes/01_bciiv2a22_cnn_patch_embed_mean.pth}"
