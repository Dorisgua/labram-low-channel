...
# PreExp44 Attention 10-channel freeze-CNN wrapper:
# use 10 real Attention channels, no prototype completion, LaBraM mean pooling,
# freeze CNN/patch_embed.
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
BASE_SCRIPT="${SCRIPT_DIR}/44Oada.finetune_attention26_labrambase_freeze_cnn.sh"
...
export FREEZE_CNN="1"
export EXP_GROUP="${EXP_GROUP:-preexp44_attention10_mean_pool_freeze_cnn_brainpro_split}"
