...
ATTENTION_O_SCRIPT="scripts/attention/44Oada.finetune_attention26_labrambase_freeze_cnn.sh"
ATTENTION_N_SCRIPT="scripts/attention/44Nada.finetune_attention10_labrambase_freeze_cnn.sh"
ATTENTION_A_SCRIPT="scripts/attention/44Aada.finetune_attention10_with_attention26_prototype_labrambase_freeze_cnn.sh"
