...
export OUTPUT_SCRIPT_NAME="${OUTPUT_SCRIPT_NAME:-siena_A_freeze_cnn}"
export CHANNEL_SUBSET="siena13" COMPLETION_SCOPE="siena13_with_siena29" POOLING_SCOPE="high" FREEZE_CNN="1"
