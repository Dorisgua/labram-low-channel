#!/usr/bin/env bash
set -euo pipefail
# LaBraM base on BCI-IV-2a multisession: full fine-tuning including CNN/patch_embed.
...
# BCI-IV-2a uses its 22 real channels directly; no channel completion/prototype.
